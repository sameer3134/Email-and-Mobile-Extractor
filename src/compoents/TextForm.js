    ...
    return (
        ...
        <div className='container my-2' >
           <div style={{color:props.mode==='dark'?'white':'#000000'}}> <h1>{props.Heading}</h1></div>
            ...
            <textarea className="form-control" value={text == null ? '' : text} onChange={handleOnChange} id="mybox" rows="8" style={{background:props.mode==='dark'?'#04070f':'white', color:props.mode==='dark'?'white':'#000000'}}></textarea>
